...
const FormSubmit = () => {
    return (
        <div className="bg min-h-screen flex items-center text-lg p-48" >
            <h3 className='text-2xl'>Please enter your name <br /> <span>and pick the Sectors <span><br />
            ...
            <form action="" className="p-10 md:w-2/3 lg:w-1/2 mx-auto rounded">
                <div className="shadow">
                    ...
                    <div className="flex items-center  rounded-t-lg border-purple-500 border-b">
